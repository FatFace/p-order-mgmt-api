...
---
{
	orders: vars.originalPayload.'pick-orders' map ( pickorder , indexOfPickorder ) -> {
		...
		"inv-contact-name": if((pickorder.customer."billing-address".fullname)!= null) (if(sizeOf(pickorder.customer."billing-address".fullname)>= 50) ((pickorder.customer."billing-address".fullname)[0 to 49]) else (pickorder.customer."billing-address".fullname)) else "",

...
---
{
	orders: vars.originalPayload.'pick-orders' map ( pickorder , indexOfPickorder ) -> {
		...
		"del-name": if((pickorder.customer.'shipping-address'.'full-name')!= null) (if(sizeOf(pickorder.customer.'shipping-address'.'full-name')>= 50) ((pickorder.customer.'shipping-address'.'full-name')[0 to 49]) else (pickorder.customer.'shipping-address'.'full-name')) else "",
		...
		"inv-name": if((pickorder.customer."billing-address".fullname) != null) (if(sizeOf(pickorder.customer."billing-address".fullname)>= 50) ((pickorder.customer."billing-address".fullname)[0 to 49]) else (pickorder.customer."billing-address".fullname)) else "",
		...
		"inv-contact-address2": if((pickorder.customer."billing-address"."address-2") != null) (if(sizeOf(pickorder.customer."billing-address"."address-2")>=60) ((pickorder.customer."billing-address"."address-2")[0 to 59]) else(pickorder.customer."billing-address"."address-2")) else "",
		"inv-contact-name": if((pickorder.customer."billing-address".fullname)!= null) (if(sizeOf(pickorder.customer."billing-address".fullname)>= 25) ((pickorder.customer."billing-address".fullname)[0 to 24]) else (pickorder.customer."billing-address".fullname)) else "",

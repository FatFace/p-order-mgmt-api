...
---
{
	orders: vars.originalPayload.'pick-orders' map ( pickorder , indexOfPickorder ) -> {
		...
		"inv-name": if((pickorder.customer."billing-address".lastname) != null) (if(sizeOf(pickorder.customer."billing-address".lastname)>= 50) ((pickorder.customer."billing-address".lastname)[0 to 49]) else (pickorder.customer."billing-address".lastname)) else " ",
